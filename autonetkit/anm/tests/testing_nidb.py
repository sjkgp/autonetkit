...
def test():
    ...
    assert(test_node._next_int_id == '1')


    # test NIDB node #2
    test_node2 = g_phy.node("r2")
    ...
    # assert(test_node.interface() == 'r1.r1 to r2')
    assert(test_node2._next_int_id == '1')
    ...
    assert(list(nidb.edges()) == "[(r4, r2, 0), (r4, r3, 0), (r5, r3, 0), (r1, r2, 0), (r1, r3, 0)]")
        # Comparison test
    r1 = nidb.node('r1')
    rb = nidb.node('r1')
    r2 = nidb.node('r2')
