...
class Layer2Builder(object):
    ...
    def build_layer2_base(self):
        g_l2 = self.anm.add_overlay('layer2')
        g_phy = self.anm['phy']
    ...
    def build_layer2_broadcast(self):
        ...
        g_l2_bc = self.anm.add_overlay('layer2_bc')
    ...
    def build_vlans(self):
        ...
        from collections import defaultdict
        g_l2 = self.anm['layer2']
        g_vlan_trunk = self.anm.add_overlay('vlan_trunk')
        g_vlans = self.anm.add_overlay('vlans')
